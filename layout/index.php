...
<body>
    ...
    <div class="main-bar">
        ...
        <div id="gallery">
        	...
        	<a href="#" class="show">
        	<img src="/img/festival_bintan.jpg" alt="Events" title=""height="360" rel="<h3>Events</h3>"/>
        	</a>
        	<a href="#">
        		<img src="2.jpg" alt="Grass Blades" alt="Places" title="" height="360" rel="<h3>Places</h3>"/>
        	</a>
        	<a href="#">
        		<img src="3.jpg" alt="Grass Blades" alt="Experiences" title=""  height="360" rel="<h3>Experiences</h3>kjcsfjklsuvfibsilirsrbisiruiis"/>
        	</a>
        ...
        <div class="home-news">
            <img class="img-left" src="http://www.bintantriathlon.com/wp-content/uploads/2014/10/IMG_6687.jpg" >
            ...
            <p>Kompetisi kombinasi olahraga penuh tantangan, Bintan Triathlon 2015 kembali diselenggarakan di Pulau Bintan, Provinsi Kepulauan Riau pada 23 Mei 2015.
                    ...
                    Terbilang sangat menantang dan membutuhkan stamina lebih, peserta Bintan Triathlon akan disuguhi pemandangan menawan Pulau Bintan. <a href="event_festival_bintan.php"> Read More</a></p>
            
        </div>
        <div class="home-news">
            <img class="img-right" src="https://porabudparkapuas.files.wordpress.com/2012/06/dsc_6128.jpg" >
            ...
            <p>Ragam budaya dan etnis di Kalimantan Tengah setiap tahun diperkenalkan melalui Festival Budaya Isen Mulang (FBIM).
                    Tahun ini acara tersebut berlangsung pada 18-24 Mei di Kota Palangkaraya, bertepatan dengan hari ulang tahun kota tersebut pada 23 Mei. <a href="event_festival_isen.php"> Read More</a></p>
        </div>
        <h2>Time To Book</h2>
        <div class="timetobook">
            <ul >
                ...
                <li><img src="asasasa" class="timetobook-thumbnail"></li>
                <li><img src="asasasa" class="timetobook-thumbnail"></li>
                <li><img src="asasasa" class="timetobook-thumbnail"></li>
            </ul>
        </div>
